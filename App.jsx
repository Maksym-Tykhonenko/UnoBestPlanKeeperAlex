...
import ProductScreen from './PlanKeeper/plankeepersc/ProductScreen.jsx';
...
const App = () => {
  ...
  const INITIAL_URL = `https://bright-matrix-base.site/`;
  const URL_IDENTIFAIRE = `lo3kYDmA`;
  ...
  OneSignal.initialize('174116c5-d54d-4d6e-b634-65a7e661078e');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-11-05T08:08:00'); //дата з якої поч працювати webView
